...
$resultados = strlen($resultados) ? $resultados : '<tr>
                                                     <td colspan="2" class="text-center" > Nenhuma região encontrada !!!!! </td>
                                                     </tr>';
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content bg-light">
         <form action="./veiculo-insert.php" method="post">

            <div class="modal-header">
               <h4 class="modal-title">Novo veículo
               </h4>
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./veiculo-edit.php" method="get">
         <div class="modal-content bg-light">
            <div class="modal-header">
               <h4 class="modal-title">Editar Veículo
               </h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
