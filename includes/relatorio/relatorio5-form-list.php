...
foreach ($listar as $item) {
    ...
    <td style="text-transform:uppercase; text-align:left">' . $item->ocorrencias . '</td>
...
<section class="content">
    <div class="container-fluid">
                            ...
                            <span style="padding:7px">
                                ...
                                <span style="padding:7px">
                                    <a href="relatorio-list5.php">
                                        <button class="btn btn-danger"><i class="fa fa-circle"
                                                style="color:#25e958"></i> &nbsp TOTAL OCORRÊNCIA
                                        </button>
                                    </a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-8">
                <div class="card">
                    <div class="card-header border-0" style="background-color:#2f3ab9;">
                        <form name="form1" action="relatorio-list5.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <select class="form-control select" style="width: 100%;" name="ocorrencias_id">
                                            <option value="">OCORRRÊNCIA</option>
                                            <?php
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class="centro"><?= $nov ?></th>
                                                <th class="centro"><?= $dez ?></th>
                                                <th class="centro" style="color:green;font-size:20px">
                                                    <?= $total_geral ?></th>
            ...
            <div class="col-4">
                <form name="form2" action="relatorio-lis5.php" method="POST" enctype="multipart/form-data">
                    <div class="card">
