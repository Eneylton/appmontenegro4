                    ...
                    <span style="padding:7px">
                        ...
                        <span style="padding:7px">
                            <a href="relatorio-list3.php">
                                <button class="btn btn-danger"><i class="fa fa-circle" style="color:#25e958"></i>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header border-0" style="background-color:#2f3ab9;">
                        <form name="form1" action="relatorio-list3.php" method="POST" enctype="multipart/form-data">
