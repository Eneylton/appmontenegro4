...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      &nbsp;
                       ...
                       <a href="formaPagamento-delete.php?id=' . $item->id . '">
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content bg-light">
         <form action="./formaPagamento-insert.php" method="post">

            <div class="modal-header">
               <h4 class="modal-title">Nova Forma de pagamento
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./formaPagamento-edit.php" method="get">
         <div class="modal-content bg-light">
            <div class="modal-header">
