...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      &nbsp;
                       ...
                       <a href="tipo-delete.php?id=' . $item->id . '">
...
$resultados = strlen($resultados) ? $resultados : '<tr>
                                                     <td colspan="6" class="text-center" > Nenhum tipo encontrada !!!!! </td>
                                                     </tr>';
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content bg-light">
         <form action="./tipo-insert.php" method="post">

            <div class="modal-header">
               <h4 class="modal-title">Novo tipo
               </h4>
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./tipo-edit.php" method="get">
         <div class="modal-content bg-light">
            <div class="modal-header">
