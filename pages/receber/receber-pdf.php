...
foreach ($listar as $item) {
    ...
    $res .= '   <tr>
                        <td style="text-align:center;width:20px">' . $contador . '</td>
                        <td style="text-align:left;width:120px">' . date('d/m/Y  Á\S  H:i:s', strtotime($item->data)) . '</td>
                        <td style="text-align:left;width:150px">' . $item->cliente . '</td>
                        <td >' . $item->qtd . '</td>
...
<body>
    ...
    <table style="margin-top: -40px;">
        <tbody>
            <tr style="background-color: #fff; color:#000">
                ...
                <td style="text-align:center; font-weight:600; font-size:16px; border:1px solid #fff;">• LISTA DE ITENS
                    RECEBIDOS •</td>
    ...
    <table>
        <tbody>
            ...
            <tr style="background-color:#fff; color:#000; ">
                <td style="text-align: center; text-transform:uppercase; font-size:15px;border-color:1px solid #fff;">
                    CLIENTE: </td>
                <td style="text-align: lefet; text-transform:uppercase; font-size:15px;border-color:1px solid #fff;"
                    colspan="5"><?= $cli ?></td>
            </tr>
            <tr style="background-color:#268360; color:#fff">
                <td style="text-align: center; text-transform:uppercase" colspan="6">Lista de itens recebidos</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <span style="font-size: 15px;"><?php echo $total_sub; ?></span>
                </td>
                <td>
                    <span style="color:ff0000; font-size:15px"><?php echo $disp . " DISPONIVÉIS" ?></span>
                </td>
                <td>
                    <span style="font-size: 15px;"><?php echo $total_disp; ?></span>
                </td>
            </tr>
