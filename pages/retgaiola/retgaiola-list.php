...
define('TITLE', 'Lista de Itens Retornados');
...
$pagination = new Pagination($qtd, $_GET['pagina'] ?? 1, 500);
...
INNER JOIN
tipo AS t ON (r.tipo_id = t.id)', 'r.status=1', 'r.id desc', $pagination->getLimit());
...
include __DIR__ . '../../../includes/retgaiola/retgaiola-form-list.php';
