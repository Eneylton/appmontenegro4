...
define('TITLE','Lista de Forma de Pagamento');
...
$qtd = FormaPagamento:: getQtd($where);

$pagination = new Pagination($qtd, $_GET['pagina'] ?? 1, 10);

$listar = FormaPagamento::getList('*','forma_pagamento',$where, 'id desc',$pagination->getLimit());
