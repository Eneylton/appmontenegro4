...
define('TITLE', 'TOTAL GERAL ENTREGA / DEVOLUÇÃO POR LOTE DE NOTIFICAÇÃO');
...
INNER JOIN
setores AS st ON (p.setores_id = st.id)', null, null, null, null);
...
include __DIR__ . '../../../includes/relatorio/relatorio3-form-list.php';
